...
#The results given provide 3 types of data, there are characteristic pieces of data like the players name and team, there's quantifiable data like the number of game starts, or free throws, and theres also a category for awards the player has received. 
...
#After sorting all players by respective position, we see that the majority of players are shooting gaurds, while the smallest number of players is the power fowards. Based on this data we could assume that most NBA teams try and make their offense more physical with rebounds.
...
#From this data we see that shooting gaurd has 191 players in that position while power foward now has the least amount at 134. This is backwards from what we saw in the initial data count summary. 
...
#I think looking at this data, one position that I would be interested in exploring a story with is the power foward position. Because it is so physical and you deal the most with fighting for rebounds and playing aggressive in the paint, I would want to figure out why certain PFs have more or less game time and connect that to the concept of load management. Why do some players have over 2000 minutes played while still being able to have a high turn-over percentage?
